...
#   category_name_to_threshold = {'animal': default_threshold}
...
#    category_name_to_threshold['animal']
    parser.add_argument('--animal_threshold', type=float, default=options.default_threshold,
                        help='Confidence threshold for the animal category')
    parser.add_argument('--human_threshold', type=float, default=options.default_threshold,
                        help='Confidence threshold for the human category')
    parser.add_argument('--vehicle_threshold', type=float, default=options.default_threshold,
