...
#%% Inference
# args.classlist = 'https://storage.googleapis.com/download.tensorflow.org/data/ImageNetLabels.txt'
# args.frozen_graph = "https://tfhub.dev/google/imagenet/resnet_v2_152/classification/4"

# m = tf.keras.Sequential([
#    hub.KerasLayer(args.frozen_graph)
#])
...
with model_graph.as_default():
    ...
    with tf.io.gfile.GFile(args.frozen_graph, 'rb') as fid:
...
with model_graph.as_default():
    ...
    with tf.compat.v1.Session() as sess:
        ...
        image_tensor = tf.compat.v1.get_default_graph().get_tensor_by_name('input:0')
        predictions_tensor = tf.compat.v1.get_default_graph().get_tensor_by_name('output:0')
